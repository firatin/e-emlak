<%@ Page Title="" Language="C#" MasterPageFile="~/AnaSite.Master" AutoEventWireup="true" CodeBehind="ilan.aspx.cs" Inherits="WEBEmlak.İlan" %>
            ...
            <asp:DataList ID="RpOrtailanlar" runat="server" RepeatColumns="3">
                <ItemTemplate>
                    ...
                    <div class="property myspan">
                        ...
                        <div class="title">
                            <h2><a href="/<%#Eval("ilanId")%>-<%#Kontrol.UrlSeo(Eval("ilanAdi").ToString().ToLower())%>.html" title="<%#Eval("ilanAdi")%>"><%#Kontrol.OzetCek((Eval("ilanAdi").ToString()),22)%>...</a></h2>
                        </div>
                        <!-- /.title -->
