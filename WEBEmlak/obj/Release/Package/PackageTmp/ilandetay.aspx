        ...
        <div class="row">
            ...
            <asp:Label ID="lblKonum" runat="server"></asp:Label>
                    ...
                    <tr>
                        ...
                        <div id="divKirala" runat="server" visible="false">
                            ...
                            <asp:Label ID="Label6" runat="server" Text="TCNo"></asp:Label>
                                    ...
                                    <td>
                                        <asp:Label ID="lblKirala" runat="server" ForeColor="#CC3300" ></asp:Label>
                                        <br />
                                        <asp:TextBox ID="txtTcno" runat="server" Width="220px" ValidationGroup="Kira"></asp:TextBox>
                                        <asp:FilteredTextBoxExtender ID="txtTcno_FilteredTextBoxExtender" runat="server" Enabled="True" FilterType="Numbers" TargetControlID="txtTcno">
                            ...
                            <asp:Label ID="Label2" runat="server" Text="Ad"></asp:Label>
                                    ...
                                    <td>
                            <asp:TextBox ID="txtAd" runat="server" Width="220px" ValidationGroup="Kira"></asp:TextBox>&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="txtAd" ErrorMessage="*Adınızı Giriniz" ForeColor="#CC0000" ValidationGroup="Kira"></asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                            <asp:Label ID="Label3" runat="server" Text="Soyad"></asp:Label>
                                    ...
                                    <td>
                            <asp:TextBox ID="txtSoyad" runat="server" Width="220px" ValidationGroup="Kira"></asp:TextBox>&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="txtSoyad" ErrorMessage="*Soyadınızı Giriniz" ForeColor="#CC0000" ValidationGroup="Kira"></asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                            <asp:Label ID="Label4" runat="server" Text="Tel"></asp:Label>
                                    ...
                                    <td>
                            <asp:TextBox ID="txtTelno" runat="server" Width="220px" ValidationGroup="Kira"></asp:TextBox>
                                        <asp:FilteredTextBoxExtender ID="txtTelno_FilteredTextBoxExtender" runat="server" Enabled="True" FilterType="Numbers" TargetControlID="txtTelno">
                                        </asp:FilteredTextBoxExtender>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="txtTelno" ErrorMessage="*Telefon Giriniz" ForeColor="#CC0000" ValidationGroup="Kira"></asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                            <asp:Label ID="Label5" runat="server" Text="E-Posta" ></asp:Label>
                                    ...
                                    <td>
                            <asp:TextBox ID="txtEposta" runat="server" Width="220px" ValidationGroup="Kira"></asp:TextBox>
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="txtEposta" ErrorMessage="Email Hatalı" ForeColor="#CC3300" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" ValidationGroup="Kira"></asp:RegularExpressionValidator>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtEposta" ErrorMessage="*Mail Giriniz" ForeColor="#CC0000" ValidationGroup="Kira"></asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                            ...
                            <asp:Label ID="Label8" runat="server" Text="Giriş Tarihi"></asp:Label>
                                    ...
                                    <td>
                                        <br />
                                        <asp:TextBox ID="txtGtarih" runat="server" Width="220px" ValidationGroup="Kira"></asp:TextBox>
                                        <asp:CalendarExtender ID="clGiris" runat="server" Enabled="True" TargetControlID="txtGtarih">
                                        </asp:CalendarExtender>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ControlToValidate="txtGtarih" ErrorMessage="*Giriş Tarihi Seçiniz" ForeColor="#CC0000" ValidationGroup="Kira"></asp:RequiredFieldValidator>
                                        <br />
                                    </td>
                                </tr>
                                <tr>
                            ...
                            <asp:Label ID="Label9" runat="server" Text="Çıkış Tarihi"></asp:Label>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtCtarih" runat="server" Width="220px" ValidationGroup="Kira"></asp:TextBox>
                                        <asp:CalendarExtender ID="clCikis" runat="server" Enabled="True" TargetControlID="txtCtarih">
                                        </asp:CalendarExtender>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ControlToValidate="txtCtarih" ErrorMessage="*Çıkış Tarihi Seçiniz" ForeColor="#CC0000" ValidationGroup="Kira"></asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                                <tr><br />
                                    <td>&nbsp;</td>
                                    <td>
                                        <asp:Button ID="btnKirala" runat="server" Text="Başvur" CssClass="btn-inverse" Height="36px" Width="134px" OnClick="btnKirala_Click1" ValidationGroup="Kira" />
                ...
                <asp:Literal ID="ltrlAciklama" runat="server"></asp:Literal>
                        ...
                        <h2 id="divVideo" runat="server">İlanın Tanıtım Videosu</h2>
                         <p>
                             <%--<asp:HyperLink ID="hprUrl" runat="server" BackColor="White" ForeColor="Red">İlanla İlgili Videoyu İzlemek İçin Tıklayınız</asp:HyperLink>--%>
    ...
    <div class="content">
        <div>
            ...
            <div class="control-group">
                <label class="control-label" for="inputEmail">
                   ...
                   <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtMail" ErrorMessage="*" ForeColor="Red" ValidationGroup="grbMesaj"></asp:RequiredFieldValidator>
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" runat="server"  ControlToValidate="txtMail" ErrorMessage="Hatalı Email" ForeColor="Red" ValidationGroup="grbMesaj" ></asp:RegularExpressionValidator>
                </label>
                <div class="controls">
                        <asp:TextBox ID="txtMail" runat="server" TargetControlID="txtTel" Width="220px"></asp:TextBox>
                </div><!-- /.controls -->
            </div><!-- /.control-group -->
              <div class="control-group">
                <label class="control-label" for="inputEmail">
                ...
                <div class="controls">
                    <asp:TextBox ID="txtTel" runat="server" Width="220px"></asp:TextBox>
                </div><!-- /.controls -->
            </div><!-- /.control-group -->
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <asp:TextBox ID="txtMesaj" runat="server" MaxLength="500" ViewStateMode="Disabled" onkeyup="textCounter(this, this.form.remLen, 500);" TextMode="MultiLine" Width="220px"></asp:TextBox>
                </div><!-- /.controls -->
            </div><!-- /.control-group -->
