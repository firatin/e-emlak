<%@ Page Title="" Language="C#" MasterPageFile="~/yonetim/AnaPage.Master" AutoEventWireup="true" CodeBehind="ilanekle.aspx.cs" Inherits="WEBEmlak.yonetim.ilanekle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="block">
        ...
        <div class="block-body">
            <table class="auto-style1">
                <tr>
                    <td class="auto-style30">İlan Tipi</td>
                ...
                <tr id="trKonutTipi" runat="server">
                    <td class="auto-style30">Konut Tipi</td>
                    <td class="auto-style9">:<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="ddKonutTipi" ErrorMessage="Konut Tipi Seçiniz" ForeColor="Red" InitialValue="0" ValidationGroup="grbilan">*</asp:RequiredFieldValidator>
                    </td>
                    <td>
                ...
                <tr id="trisyeriTipi" runat="server" visible="false">
                    <td class="auto-style30">İşyeri Tipi</td>
                    <td class="auto-style9">:<asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="ddisyeriTipi" ErrorMessage="İşyeri Tipi Seçiniz" ForeColor="Red" InitialValue="0" ValidationGroup="grbilan">*</asp:RequiredFieldValidator>
                    </td>
                    <td>
                ...
                <tr id="trArsaTipi" runat="server" visible="false">
                    <td class="auto-style30">Arsa Tipi</td>
                    <td class="auto-style9">:<asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="ddArsaTipi" ErrorMessage="Arsa Tipi Seçiniz" ForeColor="Red" InitialValue="0" ValidationGroup="grbilan">*</asp:RequiredFieldValidator>
                    </td>
                    <td>
                ...
                <tr>
                 ...
                 <tr id="trArsaTapu" runat="server" visible="false">
                    <td class="auto-style30">Tapu Durumu</td>
                    <td class="auto-style9">:<asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ControlToValidate="ddTapu" ErrorMessage="Tapu Durumu Seçiniz" ForeColor="Red" InitialValue="0" ValidationGroup="grbilan">*</asp:RequiredFieldValidator>
                     </td>
                    <td>
                ...
                <tr>
                    ...
                    <td class="auto-style9">:<asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ControlToValidate="ddDanisman" ErrorMessage="Danışman Seçiniz" ForeColor="Red" ValidationGroup="grbilan" InitialValue="0">*</asp:RequiredFieldValidator>
                    </td>
                    <td>
        ...
        <div class="block-body">
            &nbsp;<table class="auto-style1">
                ...
                <tr runat="server" id="trEvOda">
                    <td class="auto-style12">Oda Sayısı</td>
                    <td class="auto-style9">:</td>
                    <td class="auto-style10">
                    ...
                    <td class="auto-style11">Yatak Odası</td>
                    <td class="auto-style9">:</td>
                    <td>
                ...
                <tr runat="server" id="trEvBalkonBahce">
                    <td class="auto-style12">Balkon</td>
                    <td class="auto-style9">:</td>
                    <td class="auto-style10">
                    ...
                    <td class="auto-style11">Bahçe</td>
                    <td class="auto-style9">:</td>
                    <td>
    ...
    <div class="block" id="div1" runat="server">
        ...
        <div class="block-body">
            ...
            <CKEditor:CKEditorControl ID="CKEditorControl1" runat="server" Height="120px" Width="500px"></CKEditor:CKEditorControl>
...
<table class="auto-style1">
        <tr>
            ...
            <td class="auto-style32">
                <asp:Button ID="btnEkle" runat="server" CssClass="btn" Height="40px" Text="İlanı Ekle" ValidationGroup="grbilan" Width="110px" OnClick="btnEkle_Click" />
